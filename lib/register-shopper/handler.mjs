...
import { v4 as uuidv4 } from 'uuid';export const handler = async (event) => {
	// specify credentials 
	...
	const uuid = uuidv4();	// Check if the shopper's username already exists
